...
//    	toExportStream = exportMetadata(context, objectModel, query, scope, filters);
    	...
    	if(exportStrategySelector!=null || exportStrategies.containsKey(exportStrategySelector)) {
    		...
    		exportStrategy.setupExporter(request.getParameters());
    	} else {
	...
	/**
	 * @return 	una lista de opciones disponibles para exportación de resultados de statistics, por ejemplo : "statistics-discovery.exporter.selector.csv", etc.
	 */
